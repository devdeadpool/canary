...
CREATE TABLE IF NOT EXISTS `players` (
    ...
    `skill_taijutsu` int(10) UNSIGNED NOT NULL DEFAULT '10',
    `skill_taijutsu_tries` bigint(20) UNSIGNED NOT NULL DEFAULT '0',
    `skill_fuinjutsu` int(10) UNSIGNED NOT NULL DEFAULT '10',
    `skill_fuinjutsu_tries` bigint(20) UNSIGNED NOT NULL DEFAULT '0',
    `skill_bukijutsu` int(10) UNSIGNED NOT NULL DEFAULT '10',
    `skill_bukijutsu_tries` bigint(20) UNSIGNED NOT NULL DEFAULT '0',
    `skill_axe` int(10) UNSIGNED NOT NULL DEFAULT '10',
    `skill_axe_tries` bigint(20) UNSIGNED NOT NULL DEFAULT '0',
    `skill_genjutsu` int(10) UNSIGNED NOT NULL DEFAULT '10',
    `skill_genjutsu_tries` bigint(20) UNSIGNED NOT NULL DEFAULT '0',
    `skill_resistance` int(10) UNSIGNED NOT NULL DEFAULT '10',
    `skill_resistance_tries` bigint(20) UNSIGNED NOT NULL DEFAULT '0',
...
INSERT INTO `players`
(`id`, `name`, `group_id`, `account_id`, `level`, `vocation`, `health`, `healthmax`, `experience`, `lookbody`, `lookfeet`, `lookhead`, `looklegs`, `looktype`, `ninjutsu`, `mana`, `manamax`, `manaspent`, `town_id`, `conditions`, `cap`, `sex`, `skill_fuinjutsu`, `skill_fuinjutsu_tries`, `skill_bukijutsu`, `skill_bukijutsu_tries`, `skill_axe`, `skill_axe_tries`, `skill_genjutsu`, `skill_genjutsu_tries`) VALUES
