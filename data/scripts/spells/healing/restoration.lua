...
function onGetFormulaValues(player, level, ninjutsu)
	local min = (level * 1.4 / 5) + (ninjutsu * 9.22 * 1.4) + 44 * 1.4
	local max = (level * 1.4 / 5) + (ninjutsu * 10.79 * 1.4) + 79 * 1.4 -- TODO: Formulas (Right now using 40% extra on Ultimate Healing with closer min and max values to the avg)
	return min, max
end
