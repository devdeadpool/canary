...
berserk:setParameter(CONDITION_PARAM_SKILL_RESISTANCE, -10)
...
bullseye:setParameter(CONDITION_PARAM_SKILL_GENJUTSU, 5)
bullseye:setParameter(CONDITION_PARAM_SKILL_RESISTANCE, -10)
...
local function magicshield(player)
	...
	condition:setParameter(CONDITION_PARAM_MANASHIELD, math.min(player:getMaxMana(), 300 + 7.6 * player:getLevel() + 7 * player:getNinjutsuLevel()))
