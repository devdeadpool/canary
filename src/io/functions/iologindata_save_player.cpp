...
bool IOLoginDataSave::savePlayerFirst(const std::shared_ptr<Player> &player) {
	...
	query << "`ninjutsu` = " << player->magLevel << ",";
	...
	query << "`skill_taijutsu` = " << player->skills[SKILL_TAIJUTSU].level << ",";
	query << "`skill_taijutsu_tries` = " << player->skills[SKILL_TAIJUTSU].tries << ",";
	query << "`skill_fuinjutsu` = " << player->skills[SKILL_FUINJUTSU].level << ",";
	query << "`skill_fuinjutsu_tries` = " << player->skills[SKILL_FUINJUTSU].tries << ",";
	query << "`skill_bukijutsu` = " << player->skills[SKILL_BUKIJUTSU].level << ",";
	query << "`skill_bukijutsu_tries` = " << player->skills[SKILL_BUKIJUTSU].tries << ",";
	query << "`skill_axe` = " << player->skills[SKILL_AXE].level << ",";
	query << "`skill_axe_tries` = " << player->skills[SKILL_AXE].tries << ",";
	query << "`skill_genjutsu` = " << player->skills[SKILL_GENJUTSU].level << ",";
	query << "`skill_genjutsu_tries` = " << player->skills[SKILL_GENJUTSU].tries << ",";
	query << "`skill_resistance` = " << player->skills[SKILL_RESISTANCE].level << ",";
	query << "`skill_resistance_tries` = " << player->skills[SKILL_RESISTANCE].tries << ",";
